...
TEST_CASE("TEST_CASE First base case") {
	std::string input = "kkkkkkz";
	ShortPalindrome s;
	ull actual = s.solve(input);
	ull expected = 15;

	REQUIRE(expected == actual);
}

TEST_CASE("TEST_CASE Second base case") {
	std::string input = "ghhggh";
	ShortPalindrome s;
	ull actual = s.solve(input);
	ull expected = 4;
...
TEST_CASE("TEST_CASE custom") {
	std::string input = "ghhghhggh";
	ShortPalindrome s;
	ull actual = s.solve(input);
	ull expected = 23;
